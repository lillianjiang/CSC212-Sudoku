...
public class SudokuGame {
	...
	public int board[][];
	public static int easy[][] = { { 0, 0, 8, 0, 9, 1, 7, 0, 4 }, 
								   { 7, 0, 0, 8, 2, 0, 0, 9, 3 },
								   { 9, 5, 2, 0, 4, 0, 1, 0, 0 }, 
								   { 0, 3, 9, 1, 0, 4, 6, 0, 0 }, 
								   { 6, 8, 1, 0, 0, 0, 3, 4, 0 },
	 ...
	 * aaa[][] is a test.
	 */
	public static int aaa[][] ={ { 0, 6, 8, 5, 9, 1, 7, 2, 4 }, 
								 { 7, 1, 4, 8, 2, 6, 5, 9, 3 },
								 { 9, 5, 2, 3, 4, 7, 1, 9, 3 }, 
								 { 0, 3, 9, 1, 8, 4, 6, 7, 2 }, 
								 { 6, 8, 1, 7, 5, 2, 3, 4, 9 },
	...
	public static int medium[][] = { { 3, 0, 6, 5, 0, 8, 4, 0, 0 },
									{ 5, 2, 0, 0, 0, 0, 0, 0, 0 },
									{ 0, 8, 7, 0, 0, 0, 0, 3, 1 }, 
									{ 0, 0, 3, 0, 1, 0, 0, 8, 0 }, 
									{ 9, 0, 0, 8, 6, 3, 0, 0, 5 },
									...
									{ 0, 0, 0, 0, 0, 0, 0, 7, 4 },
									{ 0, 0, 5, 2, 0, 6, 3, 0, 0 } };
	public static int difficult[][] = { { 0, 2, 0, 9, 0, 0, 0, 0, 8 }, 
										{ 0, 5, 3, 0, 0, 0, 0, 0, 0 },
										{ 8, 0, 1, 0, 5, 0, 0, 0, 0 }, 
										{ 0, 0, 6, 8, 0, 0, 2, 0, 0 }, 
										{ 0, 0, 8, 0, 0, 7, 1, 0, 0 },
	...
	public static void main(String args[]) throws IOException {
		...
		else if(lv.equals("aaa")){
			sudoku = new SudokuGame(aaa);
		}
			else {
